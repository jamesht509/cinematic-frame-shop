      ...
      <div className="container-wide py-3">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/80">⚡ {ht.urgency.flashSale}</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/80">
              <span className="font-bold text-green-400">{buyerCount}</span> {ht.urgency.boughtToday}
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <span className="text-white/80">
              <span className="font-bold text-blue-400">{Math.floor(Math.random() * 20) + 35}</span> {ht.urgency.viewingNow}
            </span>
          </div>
        </div>
      </div>
