...
interface ProductHeroSliderHTProps {
  productTitle: string;
  productPrice: string;
  currencyCode: string;
  onAddToCart: () => void;
...
export function ProductHeroSliderHT({ 
  productTitle, 
  productPrice, 
  currencyCode, 
  onAddToCart 
}: ProductHeroSliderHTProps) {
        ...
        <div className="container-wide">
          <div className="max-w-2xl">
            ...
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-sm text-white/80">{ht.hero.socialProof}</span>
            </div>
            ...
            <div className="inline-flex items-center gap-2 bg-gold/20 backdrop-blur-sm border border-gold/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-gold text-sm font-medium tracking-wide">{ht.hero.badge}</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              <div className="flex items-baseline gap-3">
                ...
                <span className="bg-red-500 text-white text-xs font-bold px-2 py-1 rounded animate-pulse">{ht.hero.price.off}</span>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-6 mt-8 text-white/60 text-sm">
              <span className="flex items-center gap-2">
                ...
                {ht.hero.trustIndicators.instantDownload}
              </span>
              <span>•</span>
