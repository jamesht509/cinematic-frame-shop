...
export function FloatingBuyButton({ price, currencyCode, onAddToCart }: FloatingBuyButtonProps) {
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden sm:flex items-center gap-2">
                <span className="text-xs text-gold font-medium uppercase tracking-wider">Limited Offer</span>
